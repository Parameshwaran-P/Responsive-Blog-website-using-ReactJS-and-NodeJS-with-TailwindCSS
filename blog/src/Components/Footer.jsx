...
const Footer = () => {
  return (
    <div className='bg-gray-900'>
        <div className='px-4 p-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4'>
        <div className='grid mb-8 lg:grid-cols-6'>
          <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
            <div>
              <p className='font-medium tracking-wide text-gray-200'>Category</p>
            ...
            <div>
              <p className='font-medium tracking-wide text-gray-200'>Apples</p>
              <ul className='mt-2 space-y-2'>
                <li>
            ...
            <div>
              <p className='font-medium tracking-wide text-gray-200'>Cherry</p>
              <ul className='mt-2 space-y-2'>
                <li>
            ...
            <div>
              <p className='font-medium tracking-wide text-gray-200'>Business</p>
              <ul className='mt-2 space-y-2'>
                <li>
          ...
          <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
              <p className='font-medium tracking-wide text-gray-200'>Subscribe for updates</p>
             ...
             <button type='submit' className='inline-flex items-center justify-center h-12 px-6 font-medium
            tracking-wide text-white transition duration-200 rounded shadow-md hover:bg-orange-500 focus:outline-none border'>
            Subscribe
             </button>
             </form>
             <p className='mt-4 text-sm text-gray-500'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Deserunt, itaque exercitationem
                officia laborum nam, rem temporibus atque numquam distinctio tenetur ad error harum repellat
                aliquam. Modi quo ut facilis? Eaque, dignissimos. Quas nihil eos quisquam saepe dolore nobis,
                fuga labore eaque modi quaerat ut? Alias aliquam eius nulla odio ipsa.</p>
            </div>
        </div>
        <div className='flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row'>
          <p className='text-gray-400'>&copy; Copyright 2024 | All right reserved.</p>
          <div className='flex items-center mt-4 space-x-4 sm:mt-0'>
            ...
            <a href="" className='text-gray-500 transition-all duration-300 hover:text-orange-500'><FaYoutube className='h-6 w-6'/></a>
